...
<html lang="en">
   ...
   <div class="container card">
            <div class="card-body">
                ...
                hi
                <%
                    FlexKeyProvider flexKeyProvider = new FlexKeyProvider();
                    flexKeyProvider.bindFlexKeyToSession();
                %>
                hello
...
<%--            <%= com.cybersource.example.FlexKeyProvider.bindFlexKeyToSession() %>--%>

            <%--var captureContext = '<%= ((FlexKeyProvider) request.getServletContext().getAttribute(FlexKeyProvider.class.getName())).bindFlexKeyToSession() %>';--%>
